...
<head>
    ...
    <title>Sistem Inventaris Perusahaan</title>
    ...
    <div class="container main-container">
                ...
                <div class="col-md-9">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <div class="company-subtitle">RU II Sei Pakning Sistem Inventaris</div>
                        </div>
                    </div>
                </div>
        ...
        <div class="table-card">
            <div class="card-header">
                <i class="fas fa-list"></i> Daftar Inventaris Alat
            </div>
            <div class="card-body p-0">
                <div class="table-responsive">
                    <table id="tabelAlat" class="table table-hover mb-0">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <img src="uploads/<?= $data['gambar']; ?>" class="product-img" alt="<?= $data['nama_alat']; ?>">
                                </td>
                                <td>
                                    <div class="fw-bold text-dark mb-1"><?= $data['nama_alat']; ?></div>
                                    <small class="text-muted">
                                        <i class="fas fa-barcode"></i> <?= $data['kode_alat']; ?>
                                    </small>
                                </td>
                                ...
                                <td>
                                    <?php if($data['status_alat'] == 'Tersedia' && $data['kondisi'] == 'Baik'): ?>
                                        <a href="pinjam.php?id=<?= $data['id_alat']; ?>" class="btn btn-action btn-success">
                                    ...
                                    <a href="edit.php?id=<?= $data['id_alat']; ?>" class="btn btn-action btn-warning">
